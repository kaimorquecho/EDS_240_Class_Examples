...
# discrete viridis scales, "d" in scale_color is for 'discrete' ----
cat_color_plot +
...
# for classed continuous color scales, classed sequential ----
con_color_plot +
...
con_color_plot +
  paletteer::scale_color_paletteer_binned("scico::batlow")
```
...
ggplot(penguins_ex1, aes(x = bill_length_mm,
                         y = bill_depth_mm,
                         color = my_color)) +
...
ggplot(penguins_ex2, aes(x = bill_length_mm, 
                         y = bill_depth_mm,
                         color = my_color)) +
  geom_point(size = 4, alpha = 0.8) +
