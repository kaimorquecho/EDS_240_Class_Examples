...
precip_data <- read_csv(here::here("data", "NCEI-county-jan20-dec24-precip.csv"), 
                        skip = 4)
...
```
```{r}
# bins have width of 10, also trying diff palette for fun ----

RColorBrewer::display.brewer.pal(n = 10, name = 'RdYlBu')

# save HEX codes as vector ----
my_brew_palette10 <- RColorBrewer::brewer.pal(n = 10, name = "RdYlBu")
base_map + 
  scale_fill_stepsn(colors = my_brew_palette10,
                    labels = scales::label_percent(scale = 1),
                    breaks = scales::breaks_width(width = 10),
