...
font_add_google(name = "Josefin Sans",
                family = "josefin") # family = is what we will use to call the font down the line, you can choose what to call it
...
showtext_auto() # code that will handle the application of fonts in all graphic devices
#..........................import data...........................
...
subtitle <- glue::glue("<span style='font-family:fa-regular;'>{money_icon};</span>
                       ...
                       workers by occupation in 2016") ### this on its own cannot be understood by R, it needs help understanding HTML, hence ggtext package
...
plot <- ggplot(subset_jobs) +
  ...
  theme(
    ...
    plot.subtitle = element_textbox(family = "sen",
                                 size = 11.5,
                                 ...
                                 margin = margin(t = 2, 
                                                 ...
                                                 b = 6,
                                                 l = 0)),
    plot.caption = element_textbox(family = "sen",
                                face = "italic",
                                color = earnings_pal["light_text"],
                                margin = margin(t = 15),
                                halign = 1,
...
ggsave(filename = here::here("week6", "images", "salary_plot.png"),
       plot = plot,
       device = "png",
       width = 8,
       height = 7 ,
