...
us_state_pop <- read_csv(here::here("week2","data","us_state_pop.csv"))
...
lyme_pop |> 
  ...
  scale_y_continuous(expand = c(0,NA)) # expands values so they start at 0
...
lyme_pop |> 
  ...
  geom_area(position = "fill") + # this makes it a filled out block 
