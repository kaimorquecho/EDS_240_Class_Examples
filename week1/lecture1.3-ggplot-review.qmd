...
ggplot(data = penguins,
       mapping = aes(x = bill_length_mm, y = bill_depth_mm,
                     color = species)) +
  geom_point() +
  scale_color_manual(values = c("gold2","cyan4","indianred2"))
...
ggplot(data = penguins,
       mapping = aes(x = bill_length_mm, y = bill_depth_mm,
                     color = body_mass_g)) +
  geom_point() +
  scale_color_gradient(low = "indianred2", high = "cyan4")
...
ggplot(data = penguins,
  ...
  geom_point()  # makes all points red because it thinks blue = a variable
...
# create ggplot with layers from different dfs ----
  ...
  mapping = aes(x = bill_length_mm,
              y = bill_depth_mm,
  color = species)) + # when aes is in the geom function, ensure to call the arguments ("data","mapping" etc) 
...
ggplot(data = penguins,
       mapping = aes(x = bill_length_mm, y = bill_depth_mm,
                     color = species)) +
  geom_point() +
  geom_smooth(method = "lm") + # we get 3 lm's because when set color = species it separates data into 3 subsets 
  scale_color_manual(values = c("gold2","cyan4","indianred2"))
```
...
ggplot(penguins, aes(x = species)) +
  geom_bar() # the default is stat = "identity"
...
scale_fill_manual(values = c("gold2","cyan4","indianred2")) +
  labs(x = "Flipper length",
       y = "Frequency",
      fill = "Species", 
  title = "Penguin Flipper Lengths") +
  facet_wrap(~species, ncol = 1)  # the "~" means "by", "facet by"
